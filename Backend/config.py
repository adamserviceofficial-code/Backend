...
class Telegram:
    ...
    FRONTEND_LINK = getenv("FRONTEND_LINK", "")
    ...
    MANUAL_CHANNEL = [channel.strip() for channel in (getenv("MANUAL_CHANNEL") or "").split(",") if channel.strip()]
    ...
    REPORT_CHANNEL = getenv("REPORT_CHANNEL", "")
